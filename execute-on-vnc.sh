...
# Source: https://joel-costigliola.github.io/assertj/assertj-swing-running.html#dont-disrupt-desktop
# And: https://github.com/croesch/beefiles/blob/master/src/execute-on-vnc.sh
